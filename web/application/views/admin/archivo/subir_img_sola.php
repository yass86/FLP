<form id="archivo" method="post" action="<?php echo site_url('archivo/control_archivo/subirarchivo_img')?>"  enctype="multipart/form-data">        
      
    <div class="form-item field-titulo">
        <label for="">Tipo Imagen<span>*</span></label>
        <select id="select-tipo" class="wrapper-select" name="tipo">
    ...
    <div class="form-item field-idgaleria">
        ...
        <input type="hidden" name="idimagen" id="idimagen" value="<?php echo $id?>">        
    ...
    <div class="form-item field-idgaleria">
        ...
        <input type="file" name="archivo" id="file" value="">
    </div>                                                          
