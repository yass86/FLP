<div id="evaluaciones">
    <fieldset class="formulario">
        <legend>NOTA COMPORTAMIENTO</legend>
        <table class="tabalasedes">
            ...
            <tr>
                ...
                <td>PERIODO</td><td>
                  ...
                  <td><input type="button" value="LISTAR" class="boton" id="notaComporta"></td>
            </tr>
...
$("#IDProgram").change(function(){
    ...
    $("#notaComporta").click(function(){
        ...
        getHtml("lista", "module1/getStudentConductNoteCatalogByGroup/"+ano+"/"+periodo+"/"+IDGroup);
        $("#lista").show(); 
    });
    $(".casilla").live("change",function(){       
        ...
        var notevalor = $(this).attr("value");
        idAC = idAC.split("_");
        getHtml("error", "module1/insertConductNote/"+IDGroup+"/"+idAC[1]+"/"+ano+"/"+periodo+"/"+notevalor);
    });
