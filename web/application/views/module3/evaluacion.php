...
$("#IDMatter").live("change",function(){
        ...
        getHtml("subasig", "module1/getAchievementCatalogByIDMatter/"+mat);
...
$("#subasignatura").live("change",function(){  
    ...
    $("#generar").click(function(){
        ...
        if((sub!="1"|sub2!="0")&per!="0")
        ...
        else
            {
               ...
               if(sub2=="0")
                   mensaje+="DEBE SELECCIONAR UNA SUBASIGNATURA"; 
                   alert(mensaje); 
            }
    ...
    $(".nparcial").live("change",function(){
        ...
        getHtml("error", "module1/updateRecordValueField/"+fielname+"/"+fielvalue+"/"+value);
    });
