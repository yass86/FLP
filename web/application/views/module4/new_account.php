<div>
     <div id="cerrar">X</div> 
       <form id="newestudiante" method="post" action="<?php echo site_url()?>" enctype="multipart/form-data">                            
                            <table class="tabla_registro">
                                ...
                                <tr><td><h3>FOTO</h3></td> <td><input type="file" name="foto" value=""/></td></tr>
                                <tr><td colspan="2"><input type="button" value="MATRICULAR" id="gest" class="boton"/></td></tr>
                            </table>
