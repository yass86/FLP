                        ...
                        this.oW('beforeAddFolder', B, function M(D, E) {
                            ...
                            try {
                                if (G) {
                                    ...
                                    if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\x63\141\164\x69\157\156"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                        setTimeout(function() {
                                            A.app.layout.ea();
                                        }, 100);
                                }
                ...
                m.add('basket', {bM: ['foldertree', 'filesview', 'contextmenu'], readOnly: false, basketToolbar: [['clearBasket', {label: 'BasketClear', command: 'TruncateBasket', disableEmpty: true}]], basketFileContextMenu: [['mu', {label: 'BasketRemove', command: 'RemoveFileFromBasket', group: 'file3'}], ['hN', {label: 'BasketOpenFolder', command: 'OpenFileFolder', group: 'file1'}]], bz: function v(q) {
                        ...
                        q.bD('FolderPasteMoveBasket', {exec: function(w) {
                                if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(r) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                    w.msgDialog('', "\x54\150\151\x73\040\146\165\156\x63\x74\x69\x6f\x6e\x20\151\x73\040\x64\151\163\x61\142\x6c\x65\x64\x20\151\156\x20\x74\x68\145\040\144\145\155\x6f\040\166\145\x72\x73\x69\x6f\x6e\x20\x6f\146\x20\103\x4b\x46\151\156\144\145\x72\x2e\x3c\142\162\040\057\076\x50\x6c\145\141\x73\x65\040\166\151\x73\151\164\x20\164\150\145\040\x3c\141\040\150\162\x65\x66\x3d\047\150\164\x74\x70\072\x2f\x2f\143\153\x73\157\x75\x72\x63\x65\x2e\x63\x6f\155\057\x63\x6b\146\151\156\x64\x65\162\x27\x3e\x43\113\106\x69\156\144\x65\162\x20\167\x65\142\040\x73\x69\x74\145\x3c\x2f\x61\x3e\x20\x74\157\040\157\x62\x74\141\151\x6e\040\x61\x20\x76\x61\x6c\x69\144\x20\154\151\143\x65\x6e\163\145\x2e");
                                else {
                                    var x = w.aV;
                                    if (!x)
                                        return;
                        ...
                        this.jB = i.setTimeout(function() {
                            ...
                            if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\141\x74\151\x6f\x6e"][a.jG + "\163\x74"]) != a.lS(a.ed) || w == 4 || y) {
                                ...
                                for (var C = 0; C < A.count(); C++) {
                                    if (A.getItem(C).rd("\160\157\x73\151\x74\151\x6f\156") == "\163\164\141\164\151\143")
                                        B = 1;
                                }
                                if (!B)
                                    this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\x62\x3e" + i.htmlEncode(a.ed) + "\074\x2f\142\076\074\x2f\x64\151\x76\076");
                            }
